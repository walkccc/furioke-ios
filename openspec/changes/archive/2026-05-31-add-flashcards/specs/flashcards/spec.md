...
#### Scenario: Source line renders with furigana

- **WHEN** a card's source line is shown (deck or study back-face)
- **THEN** it renders as ruby — kanji with their stored readings above — parsed
  from the saved annotation without re-running the tokenizer
